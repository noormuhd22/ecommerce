...
<?php include 'adminnavbar.php'; ?> 
    ...
    <div class="col">
                ...
                <a href="addproduct.php"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addSlideModal">Add Product</button></a>
            </div>
...
$Serialnumber =1;
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='editproduct.php?id=".$row["id"]."'><button type='button' class='btn btn-primary'>Edit</button></a></td>"; 
...
function showConfirmDialog(id) {
    ...
    document.getElementById('confirmDialog').style.display = 'block';
        ...
        function confirmDelete() {
            ...
            window.location.href = "deleteproduct.php?id=" + deleteId;
        }
    </script>
