...
<div class="col-xl-4">
  <div class="card" style="width:400px">
    ...
    <div class="card-body">
      ...
      <a href="javascript:void(0)" data-productid="<?php echo $data['id'];?>" data-productname="<?php echo $data['name'];?>" data-amount="<?php echo $data['price'];?>" class="btn btn-primary buynow">Buy Now</a>
    </div>
  </div>
</div>
<?php } ?>
